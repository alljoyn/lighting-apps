Building the LSF TransitionEffect Tutorial App for Android (LSFTransitionEffectTutorial)
...
binaries needed to build the LSFTransitionEffectTutorial project. The steps to import
the project and set up the necessary path variables are as follows:
 ...
 3) Browse to the <lsf_sdk_install_dir>/android/LSFTransitionEffectTutorial, and complete
    the project import.
...
13) Repeat steps 6-10 to create another variable named "ANDROID_HOME" that's
    ...
    <adt_install_dir>/sdk).
14) Right-click on the LSFTransitionEffectTutorial project, and click "Refresh".

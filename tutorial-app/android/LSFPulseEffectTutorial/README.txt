Building the LSF PulseEffect Tutorial App for Android (LSFPulseEffectTutorial)
...
binaries needed to build the LSFPulseEffectTutorial project. The steps to import
the project and set up the necessary path variables are as follows:
 ...
 3) Browse to the <lsf_sdk_install_dir>/android/LSFPulseEffectTutorial, and complete
    the project import.
...
13) Repeat steps 6-10 to create another variable named "ANDROID_HOME" that's
    ...
    <adt_install_dir>/sdk).
14) Right-click on the LSFPulseEffectTutorial project, and click "Refresh".
...
Full Documentation can be found at <lsf_sdk_install_dir>/android/Libraries/LSFJavaHelper/doc/overview-summary.html

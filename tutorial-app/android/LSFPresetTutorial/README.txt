Building the LSF Preset Tutorial App for Android (LSFPresetTutorial)
...
binaries needed to build the LSFPresetTutorial project. The steps to import
the project and set up the necessary path variables are as follows:
 ...
 3) Browse to the <lsf_sdk_install_dir>/android/LSFPresetTutorial, and complete
    the project import.
...
13) Repeat steps 6-10 to create another variable named "ANDROID_HOME" that's
    ...
    <adt_install_dir>/sdk).
14) Right-click on the LSFPresetTutorial project, and click "Refresh".

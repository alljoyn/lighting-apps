Building the LSF PulseEffect Tutorial App for iOS (LSFPulseEffectTutorial)
...
Two Xcode "Source Tree" variables are used to reference the required binaries and header files needed to build the LSFPulseEffectTutorial 
...
7) Open the LSFPulseEffectTutorial Xcode project at the following path:
   "<lsf_sdk_install_dir>/iOS/LSFPulseEffectTutorial/LSFPulseEffectTutorial.xcodeproj"
8) In the top-left, ensure that "LSFPulseEffectTutorial" is set as the active build scheme and your are building

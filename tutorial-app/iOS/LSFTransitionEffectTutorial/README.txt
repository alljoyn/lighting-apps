Building the LSF TransitionEffect Tutorial App for iOS (LSFTransitionEffectTutorial)
...
Two Xcode "Source Tree" variables are used to reference the required binaries and header files needed to build the LSFTransitionEffectTutorial 
...
7) Open the LSFTransitionEffectTutorial Xcode project at the following path:
   "<lsf_sdk_install_dir>/iOS/LSFTransitionEffectTutorial/LSFTransitionEffectTutorial.xcodeproj"
8) In the top-left, ensure that "LSFTransitionEffectTutorial" is set as the active build scheme and your are building

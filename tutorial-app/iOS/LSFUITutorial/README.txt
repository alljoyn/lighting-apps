Building the LSF UI Tutorial App for iOS (LSFUITutorial)
...
Two Xcode "Source Tree" variables are used to reference the required binaries and header files needed to build the LSFUITutorial 
...
7) Open the LSFUITutorial Xcode project at the following path:
   "<lsf_sdk_install_dir>/iOS/LSFUITutorial/LSFUITutorial.xcodeproj"
8) In the top-left, ensure that "LSFUITutorial" is set as the active build scheme and your are building

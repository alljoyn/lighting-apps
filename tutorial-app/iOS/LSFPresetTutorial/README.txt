Building the LSF Preset Tutorial App for iOS (LSFPresetTutorial)
...
Two Xcode "Source Tree" variables are used to reference the required binaries and header files needed to build the LSFPresetTutorial 
...
7) Open the LSFPresetTutorial Xcode project at the following path:
   "<lsf_sdk_install_dir>/iOS/LSFPresetTutorial/LSFPresetTutorial.xcodeproj"
8) In the top-left, ensure that "LSFPresetTutorial" is set as the active build scheme and your are building
